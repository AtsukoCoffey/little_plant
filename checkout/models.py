...
class Order(models.Model):
    ...
    def _generate_order_number(self):
        """
        Generate a random, unique number using UUID - string of 32 characters
        """
    ...
    def update_total(self):
        ...
        delivery costs.
        related name'lineitems'(FK) OrderLineItem model: lineitem_total
        """
        self.order_total = self.lineitems.aggregate(
            # Default behaviour is to add a new field - lineitem_total__sum
...
class OrderLineItem(models.Model):
    ...
    product = models.ForeignKey(
        PlantItem, null=False, blank=False, on_delete=models.CASCADE
    )
