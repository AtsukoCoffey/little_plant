...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',  # noqa required allauth
...
# Default static and media files settings
...
# Amazon AWS S3 settings - change static, media settings
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = os.environ.get('email@backends.console')
else:
...
# Delivery info for chaeckout calculation
